...
public class RootLayoutController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		CheckMenuItem item1 = new CheckMenuItem("5 Card Draw");
		...
		CheckMenuItem item2 = new CheckMenuItem("5 Card Joker Poker");
		...
		CheckMenuItem item3 = new CheckMenuItem("Texas Hold 'Em");
		...
		CheckMenuItem item4 = new CheckMenuItem("Omaha");
		...
		CheckMenuItem item5 = new CheckMenuItem("Seven Card Draw");
		item3.selectedProperty().addListener(new ChangeListener(){
			@Override
			public void changed(ObservableValue arg0, Object arg1, Object arg2) {
		...
		CheckMenuItem item6 = new CheckMenuItem("Deuces Wild");
		item3.selectedProperty().addListener(new ChangeListener(){
			@Override
			public void changed(ObservableValue arg0, Object arg1, Object arg2) {
